...
export default [
	// Safe
	{
		...
		func: '../src/modules/safe/removeRedundantBlockStatements.js',
		source: `if (a) {{do_a();}}`,
		expected: `if (a) {\n  do_a();\n}`,
	},
	{
	...
	},
	{
		...
		func: '../src/modules/safe/normalizeComputed.js',
	...
	},
	{
		...
		func: '../src/modules/safe/normalizeEmptyStatements.js',
		source: `;;var a = 3;;`,
		expected: `var a = 3;`,
	},
	{
	...
	},
	{
		...
		func: '../src/modules/safe/parseTemplateLiteralsIntoStringLiterals.js',
		source: '`hello ${"world"}!`;',
	...
	},
	{
		...
		func: '../src/modules/safe/rearrangeSequences.js',
	...
	},
	{
		...
		func: '../src/modules/safe/rearrangeSwitches.js',
...
case 1: console.log(1); a = 2; break;}}})();`,
  ...
  while (true) {
	...
	},
	{
		...
		func: '../src/modules/safe/removeDeadNodes.js',
	...
	},
	{
		...
		func: '../src/modules/safe/replaceCallExpressionsWithUnwrappedIdentifier.js',
	...
	},
	{
		...
		func: '../src/modules/safe/replaceEvalCallsWithLiteralContent.js',
	...
	},
	{
		...
		func: '../src/modules/safe/replaceFunctionShellsWithWrappedValue.js',
	...
	},
	{
		...
		func: '../src/modules/safe/replaceFunctionShellsWithWrappedValueIIFE.js',
		source: `(function a() {return String}\n)()(val);`,
		expected: `String(val);`,
	},
	{
		...
		func: '../src/modules/safe/replaceIdentifierWithFixedAssignedValue.js',
	...
	},
	{
		...
		func: '../src/modules/safe/replaceIdentifierWithFixedValueNotAssignedAtDeclaration.js',
	...
	},
	{
		...
		func: '../src/modules/safe/replaceNewFuncCallsWithLiteralContent.js',
	...
	},
	{
		...
		func: '../src/modules/safe/replaceBooleanExpressionsWithIf.js',
		source: `x && y && z();`,
		expected: `if (x && y) {\n  z();\n}`,
	},
	{
	...
	},
	{
		...
		func: '../src/modules/safe/replaceSequencesWithExpressions.js',
		source: `if (a) (b(), c());`,
		expected: `if (a) {\n  b();\n  c();\n}`,
	},
	{
	...
	},
	{
		...
		func: '../src/modules/safe/resolveDeterministicIfStatements.js',
	...
	},
	{
		...
		func: '../src/modules/safe/resolveFunctionConstructorCalls.js',
	...
	},
	{
		...
		func: '../src/modules/safe/resolveMemberExpressionReferencesToArrayIndex.js',
  ...
  2,\n  2,\n  2,\n  2,\n  2,\n  2,\n  2,\n  2,\n  2,\n  2,\n  3\n];\nb = 1;\nc = 3;`,
	...
	},
	{
		...
		func: '../src/modules/safe/resolveMemberExpressionsWithDirectAssignment.js',
	...
	},
	{
		...
		func: '../src/modules/safe/resolveProxyCalls.js',
	...
	},
	{
		...
		func: '../src/modules/safe/resolveProxyReferences.js',
	...
	},
	{
		...
		func: '../src/modules/safe/resolveProxyVariables.js',
	...
	},
	{
		...
		func: '../src/modules/safe/resolveRedundantLogicalExpressions.js',
	...
	},
	{
		...
		func: '../src/modules/safe/unwrapFunctionShells.js',
	...
	},
	{
		...
		func: '../src/modules/safe/unwrapIIFEs.js',
		source: `var a = (() => {
      return b => {
        return c(b - 40);
      };
  ...
  return b => c(b - 40);
	...
	},
	{
		...
		func: '../src/modules/safe/unwrapSimpleOperations.js',
...
1 ^ 2;`,
	},
	{
		...
		func: '../src/modules/safe/separateChainedDeclarators.js',
	...
	},
	{
		...
		func: '../src/modules/safe/simplifyCalls.js',
	...
	},
	{
		...
		func: '../src/modules/safe/simplifyIfStatements.js',
		source: `if (J) {} else {}`,
		expected: `J;`,
	},
	{
	...
	// Unsafe
	{
		...
		isUtil: true,
		name: 'evalInVm - TP-1',
		func: '../src/modules/utils/evalInVm.js',
		prepareTest: a => [a],
		prepareResult: b => b,
		source: `'hello ' + 'there';`,
	...
	},
	{
		...
		func: '../src/modules/unsafe/evalWithDom.js',
		prepareTest: () => {},
		prepareResult: () => {},
		source: ``,
		expected: `function a(x) {\n  return x + 3;\n}`,
	},
	{
		...
		func: '../src/modules/unsafe/normalizeRedundantNotOperator.js',
	...
	},
	{
		...
		func: '../src/modules/unsafe/resolveAugmentedFunctionWrappedArrayReplacements.js',
		source: `1`,
		expected: ``,
	},
	{
		...
		func: '../src/modules/unsafe/resolveBuiltinCalls.js',
	...
	},
	{
		...
		func: '../src/modules/unsafe/resolveDefiniteBinaryExpressions.js',
	...
	},
	{
		...
		func: '../src/modules/unsafe/resolveDefiniteMemberExpressions.js',
	...
	},
	{
		...
		func: '../src/modules/unsafe/resolveDeterministicConditionalExpressions.js',
	...
	},
	{
		...
		func: '../src/modules/unsafe/resolveEvalCallsOnNonLiterals.js',
	...
	},
	{
		...
		func: '../src/modules/unsafe/resolveFunctionToArray.js',
	...
	},
	{
		...
		func: '../src/modules/unsafe/resolveInjectedPrototypeMethodCalls.js',
	...
	},
	{
		...
		func: '../src/modules/unsafe/resolveLocalCalls.js',
	...
	},
	{
		...
		func: '../src/modules/unsafe/resolveMinimalAlphabet.js',
	...
	// Utils
	{
		...
		func: '../src/modules/utils/areReferencesModified.js',
		prepareTest: src => {
